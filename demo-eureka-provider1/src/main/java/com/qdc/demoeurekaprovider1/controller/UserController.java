...
public class UserController {
    ...
    //addUser方法接受前端传过来的数据是json格式
    //@RequestBody把json格式转化为user对象
    ...
    public String hello(@RequestParam(value = "sleep_seconds",required = true)int sleep_secdons)
        throws InterruptedException{
        System.out.println("休眠时间"+ sleep_secdons);
        Thread.sleep(sleep_secdons*1000);
